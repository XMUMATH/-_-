...
test_inputs_dir = './data/test_mfcc'
train_inputs_dir = './data/train_mfcc'
test_labels = './data/test_syllable_to_label.txt'
train_labels = './data/train_syllable_to_label.txt'
